...
def test_get_grid_data(client):
    ...
    responses.add(
        responses.GET,
        'https://www.tvtv.us/api/v1/lineup/USA-TEST12345/grid/2023-05-23T04:00:00.000Z/2023-05-24T03:59:00.000Z/12345',
        json=mock_data,
        status=200
    )
...
def test_get_grid_data_batching(client):
    ...
    responses.add(
        responses.GET,
        'https://www.tvtv.us/api/v1/lineup/USA-TEST12345/grid/2023-05-23T04:00:00.000Z/2023-05-24T03:59:00.000Z/' + ','.join(str(c) for c in channels[:20]),
    ...
    responses.add(
        responses.GET,
        'https://www.tvtv.us/api/v1/lineup/USA-TEST12345/grid/2023-05-23T04:00:00.000Z/2023-05-24T03:59:00.000Z/' + ','.join(str(c) for c in channels[20:25]),
